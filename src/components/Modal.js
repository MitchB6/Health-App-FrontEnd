...
const Modal = ({ isOpen, onClose, onEdit, workout_exercise_id, initialReps, initialSets, initialNotes }) => {
    ...
    const handleSaveChanges = () => {
        onEdit(workout_exercise_id, editedReps, editedSets, editedNotes);
    }
